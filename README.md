...
<p align="center">
  ...
  <a href="https://nkaurelien.github.io"><img src="https://img.shields.io/badge/Portfolio-181717?style=for-the-badge&logo=githubpages&logoColor=white" alt="Portfolio"/></a>
...
- 🧑‍💻 Développeur **full stack polyvalent** & **Tech Lead / MOE**, à l'aise en autonomie comme en équipe.
- 🔒 Je me spécialise en **DevSecOps**, avec de solides bases en **SysOps** et en **ingénierie des données**.
...
![Traefik](https://img.shields.io/badge/Traefik-00E2B2?style=for-the-badge&logo=traefik&logoColor=white)
...
- 🏥 **Normes de santé & IoT (FHIR/HL7)** `[██████▒---] 65%`
- ⛓️ **RAG & Agents IA (LangChain, Ollama)** `[██████▒---] 65%`
- ☸️ **SecOps & Orchestration (Kubernetes / Argo ou Swarm)** `[██████▒---] 65%`
...
- 🌍 [**Portfolio**](https://nkaurelien.github.io)
